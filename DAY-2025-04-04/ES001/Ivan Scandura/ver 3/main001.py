...
def add_book(library, title, author, year):
    ...
    library.append(book)
    # Incrementa l'ID per il prossimo libro
    # next_id = max(library['id'] for book in library)
...
def remove_book(library, book_id):
    ...
    Args:
        library (list): Lista di dizionari che rappresentano i libri nella biblioteca.
        book_id (str): ID del libro da rimuovere.
    ...
    for book in library:
        ...
        if book["id"] == book_id:
            ...
            library.remove(book)
            print(f"Libro ID {book_id} rimosso.")
            founded = True
            break
    if not founded:
...
def search_book(library, keyword,): #available_only=False
    """
    ...
    Args:
        ...
        #available_only (bool): Se True, mostra solo i libri disponibili. (filtro)
    Returns:
        None
    """
    ...
    results = [
        ...
        and (not available_only or book["available"])
    ]
    print_books(results)
    """
...
def lend_book(library, book_id):
    ...
    Args:
        library (list): Lista di dizionari che rappresentano i libri nella biblioteca.
        book_id (str): ID del libro da prestare.
...
def return_book(library, book_id):
    ...
    Args:
        library (list): Lista di dizionari che rappresentano i libri nella biblioteca.
        book_id (str): ID del libro da restituire.
    ...
    while True:
        ...
        match choice_enum:
            case MenuOption.ADD_BOOK:
                try:
                    ...
                    while not valid_input:
                        try:
                            # Verifica se l'anno è un numero
                            year = int(input("Anno: "))

                            # Verifica se l'anno è valido
                            if year > current_year:
                                print(f"Errore: L'anno deve essere inferiore o uguale all'anno corrente ({current_year}).")
                            else:
                                add_book(library, title, author, year)
                                valid_input = True
                        except ValueError:
                            print("Errore: L'anno deve essere un numero valido.")
                        except Exception as e:
                            print(f"Errore: {e}")
                            valid_input = True
                except Exception as e:
            ...
            case MenuOption.REMOVE_BOOK:
                book_id = input("ID del libro da rimuovere: ")
            ...
            case MenuOption.LEND_BOOK:
                book_id = input("ID del libro da prestare: ")
                lend_book(library, book_id)

            case MenuOption.RETURN_BOOK: 
                book_id = input("ID del libro da restituire: ")
